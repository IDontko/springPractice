...
public class TestGenericType {
    public static void main(String[] args) {
        ...
        Type typeStudent = StudentDao.class.getGenericSuperclass();
        System.out.println(typeStudent);

        if (type instanceof ParameterizedType parameterizedType) {
            System.out.println("parameterizedType : " + parameterizedType.getActualTypeArguments()[0]);
        }
