...
public class A21 {
    ...
    public static void main(String[] args) throws Exception {
        ...
        HandlerMethod handlerMethod = new HandlerMethod(new Controller(),
                Controller.class.getMethod("test", String.class,
                        String.class, int.class, String.class,
                        MultipartFile.class, int.class, String.class,
...
//            RequestParamMethodArgumentResolver resolve = new RequestParamMethodArgumentResolver(beanFactory, false);
...
//            if (resolve.supportsParameter(parameter)){
//                Object v = resolve.resolveArgument(parameter, container, new ServletWebRequest(request), null);
